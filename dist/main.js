...
const createElements = (() => {
  ...
  const createTodayList = () => {
    ...
    let _dueTodayArray = ___WEBPACK_IMPORTED_MODULE_0__.todo.getTodayList();
    let _allTasksArray = ___WEBPACK_IMPORTED_MODULE_0__.todo.getTodoList();
...
const todo = (() => {
  ...
  console.log(_dueToday);
  console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(_todoList[1].dueDate))
