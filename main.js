...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n  overflow: auto;\n}\n\nbody {\n  margin: 0;\n  font-family: sans-serif;\n}\n\n\n.todo-app {\n  min-height: 100vh;\n  display: flex;\n}\n\n\n.side-bar {\n  border-right: 1px solid black;\n  background-color: #5b78c7;\n}\n\n\n\n.bar {\n  width: 30px;\n  height: 3px;\n  background-color: white;\n  margin: 5px;\n  border-radius: 15px;\n}\n\n\n.toggle-menu {\n  display: none;\n}\n\n\n\n\n.menu-button {\n  width: 100%;\n  margin: 50px 0;\n  padding: 10px;\n  border: none;\n  font-size: 2rem;\n  border-top: 2px solid black;\n  border-bottom: 2px solid black;\n  cursor: pointer;\n  font-weight: bold;\n  background-color: transparent;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n\n}\n\n\n.menu-button:hover {\n  background-color: blanchedalmond;\n}\n\n\n.current-menu-selected {\n  text-decoration: underline;\n  background-color: coral;\n}\n\n\n#all-todo-button::after,\n#projects-button::after,\n#today-button:after,\n#tomorrow-button::after {\n  content: attr(counter-data);\n  font-size: 1rem;\n  border: 1px solid black;\n  margin-left: 5px;\n  padding: 2px;\n\n}\n\n\n.todo-display {\n  width: 80vw;\n  margin: 2vw;\n}\n\n\n.display-menu-header {\n  text-align: center;\n}\n\n\nul {\n  padding: 0;\n}\n\n\n.list {\n  margin-bottom: 5px;\n  list-style: none; \n  border: 1px solid black;\n\n}\n\n.shown-content {\n  display: flex;\n  align-items: center;\n  \n}\n\n\n.task-done {\n  text-decoration: line-through;\n\n}\n\n\n.priority-marker {\n  height: 15px;\n  width: 15px;\n  border-radius: 50%;\n  display: inline-block;\n  margin-left: 5px;\n  vertical-align: middle;\n}\n\n.right-aligned-content {\n  margin-left: auto;\n  display: flex;\n  justify-content: space-between;\n}\n\n\n.buttons-container {\n  display: flex;\n  align-items: center;\n}\n\n.down-arrow,\n.up-arrow,\n.edit-icon {\n  width: 20px;\n}\n\n\n\n.collapse-button {\n  font-size: 0.8rem;\n  background-color: transparent;\n  border-radius: 10px;\n  border: none;\n  cursor: pointer;\n}\n\n.edit-task-button,\n.expand-button {\n  font-size: 0.8rem;\n  background-color: transparent;\n  border-radius: 10px;\n  border: none;\n  cursor: pointer;\n  display: none;\n}\n\n.expand-button,\n.collapse-button {\n  margin: 0 15px;\n\n}\n\n\n.list:hover .show{\n  display: inline-flex;\n  background-color: transparent;\n}\n\n.hide {\n  display: none;\n}\n\n.hide-collapse {\n  display: none;\n}\n\n\n.active {\n  display: inline-flex;\n}\n\n.project-info {\n  text-align: center;\n}\n\n\n\n.delete-bin {\n  width: 35px;\n}\n \n.delete-bin-button {\n  border: none;\n  cursor: pointer;\n  background-color: transparent;\n  border-radius: 15px;\n  margin-left: 10px;\n }\n \n.delete-bin-button:hover {\n  background-color: lightgrey;\n }\n\n\n.hidden-container {\n  display: none;\n  overflow: hidden;\n  background-color: #f1f1f1;\n}\n\n\n.notes-container {\n  border: 1px solid black;\n  padding: 30px;\n\n}\n\n\n\n\n\n.add-new-todo-button,\n.add-new-project-button {\n  color: white;\n  background-color: #008CBA;\n  bottom: 20px;\n  right: 20px;\n  padding: 0 15px;\n  font-size: 3rem;\n  border-radius: 50%;\n  border: 2px solid transparent;\n  cursor: pointer;\n}\n\n.add-new-todo-button:hover,\n.add-new-project-button:hover {\n  background-color: white;\n  border: 2px solid #008CBA;\n  color: #008CBA;\n}\n\n\n\n.new-todo-button-container {\n  margin: 10vh 2vw 3vh 2vw;\n  text-align: right;\n  \n}\n\n\n.stop-scrolling {\n  overflow: hidden;\n}\n\n.move-to-background {\n  opacity: 0.5;\n  pointer-events: none;\n}\n\n\n.form-container {\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(0, 0, 0, 0.7);\n  position: absolute;\n  top: 0;\n  justify-content: center;\n  display: none;\n  z-index: 1;\n}\n\n.form {\n  border: 2px solid black;\n  padding: 60px 30px;\n  background-color: white;\n  position: relative;\n  margin-top: 5vh;\n  height: 400px;\n\n}\n\n\n\n.form-header {\n  font-size: 2rem;\n  text-align: center;\n  width: 100%;\n  margin-bottom: 30px;\n}\n\n\n\n.x-button {\n  position: absolute;\n  right: 10px;\n  transform: rotate(45deg);\n  top: 3px;\n  font-size: 1.5rem;\n  cursor: pointer;\n}\n\n.x-button:hover {\n  font-size: 1.8rem;\n}\n\n\ntable {\n  border-spacing: 0 10px;\n}\n\n\n.form-label {\n  text-align: right;\n  vertical-align: top;\n}\n\ntextarea {\n  resize: none;\n}\n\n\n.form-buttons {\n  margin-top: 20px;\n  width: 100%;\n  text-align: center;\n\n}\n\n.form-buttons button {\n  border: 1px solid white;\n  padding: 5px 10px;\n  cursor: pointer;\n}\n\n\n.submit-button:hover {\n  background-color: rgb(45, 231, 255);\n  border: 1px solid black;\n}\n\n\n.cancel-button {\n  margin-left: 10px;\n\n}\n\n.cancel-button:hover {\n  background-color: rgb(180, 180, 180);\n  border: 1px solid black;\n}\n\n\n\n.project-container {\n  border: 2px solid black;\n  padding: 10px 5px;\n  margin-bottom: 10px;\n}\n\n.project-container:hover .edit-project-button {\n  display: inline-flex;\n  background-color: transparent;\n}\n\n.project-title {\n  display: flex;\n  align-items: center;\n}\n\n\n\n.edit-project-button {\n  margin-left: 50px;\n  font-size: 0.8rem;\n  background-color: transparent;\n  border-radius: 10px;\n  border: 1px solid black;\n  cursor: pointer;\n  display: none;\n}\n\n\n.delete-buttons-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-top: 20px;\n}\n\n.delete-buttons-container button {\n  width: 100%;\n  margin-bottom: 5px;\n  padding: 5px 10px;\n  border: 1px solid white;\n  cursor: pointer;\n}\n\n.delete-buttons-container button:hover {\n  background-color: red;\n  border: 1px solid black;\n  font-weight: bold;\n}\n\n\n\n\n\n@media screen and (max-width: 780px) {\n \n  .todo-app {\n    display: block;\n  }\n\n  .todo-display {\n    margin: 0 auto;\n    width: 95vw;\n  }\n\n  .toggle-menu {\n    z-index: 2;\n  }\n   \n \n  .side-bar {\n    height: 100px;\n    display: flex;\n\n  }\n  \n  .toggle-menu {\n    display: block;\n  }\n\n\n  .nav-links {\n    position: fixed;\n    background-color: #5b78c7;\n    height: 100vh;\n    width: 100%;\n    z-index: 1;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-around;\n    padding: 20px 0;\n    clip-path: circle(100px at 10% -50%);\n    -webkit-clip-path: circle(100px at 10% -50%);\n    transition: all 1s ease-out;\n\n    \n  }\n\n  .nav-links.open {\n    clip-path: circle(1200px at 10% -10%);\n    -webkit-clip-path: circle(1200px at 10% -10%);\n\n  }\n\n\n .project-info {\n   font-size: .6rem;\n }\n\n\n  .hide-small-window {\n    display: none;\n  }\n\n  .show {\n    display: inline-flex;\n  }\n \n\n  .right-aligned-content {\n    margin-left: auto;\n    display: flex;\n    justify-content: space-between;\n    flex-direction: column-reverse;\n  }\n\n  .buttons-container {\n    display: flex;\n    justify-content: space-between;\n  }\n\n \n\n  .expand-button,\n  .collapse-button {\n    margin: 0;\n\n  }\n\n\n  .delete-bin-button {\n    margin-left: 5px;\n\n  }\n\n  .delete-bin {\n    width: 25px;\n  }\n\n  .edit-project-button {\n    margin-left: auto;\n    display: inline-flex;\n  }\n\n\n\n}", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,cAAc;AAChB;;AAEA;EACE,SAAS;EACT,uBAAuB;AACzB;;;AAGA;EACE,iBAAiB;EACjB,aAAa;AACf;;;AAGA;EACE,6BAA6B;EAC7B,yBAAyB;AAC3B;;;;AAIA;EACE,WAAW;EACX,WAAW;EACX,uBAAuB;EACvB,WAAW;EACX,mBAAmB;AACrB;;;AAGA;EACE,aAAa;AACf;;;;;AAKA;EACE,WAAW;EACX,cAAc;EACd,aAAa;EACb,YAAY;EACZ,eAAe;EACf,2BAA2B;EAC3B,8BAA8B;EAC9B,eAAe;EACf,iBAAiB;EACjB,6BAA6B;EAC7B,aAAa;EACb,mBAAmB;EACnB,uBAAuB;;;AAGzB;;;AAGA;EACE,gCAAgC;AAClC;;;AAGA;EACE,0BAA0B;EAC1B,uBAAuB;AACzB;;;AAGA;;;;EAIE,2BAA2B;EAC3B,eAAe;EACf,uBAAuB;EACvB,gBAAgB;EAChB,YAAY;;AAEd;;;AAGA;EACE,WAAW;EACX,WAAW;AACb;;;AAGA;EACE,kBAAkB;AACpB;;;AAGA;EACE,UAAU;AACZ;;;AAGA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,uBAAuB;;AAEzB;;AAEA;EACE,aAAa;EACb,mBAAmB;;AAErB;;;AAGA;EACE,6BAA6B;;AAE/B;;;AAGA;EACE,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,qBAAqB;EACrB,gBAAgB;EAChB,sBAAsB;AACxB;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,8BAA8B;AAChC;;;AAGA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;;;EAGE,WAAW;AACb;;;;AAIA;EACE,iBAAiB;EACjB,6BAA6B;EAC7B,mBAAmB;EACnB,YAAY;EACZ,eAAe;AACjB;;AAEA;;EAEE,iBAAiB;EACjB,6BAA6B;EAC7B,mBAAmB;EACnB,YAAY;EACZ,eAAe;EACf,aAAa;AACf;;AAEA;;EAEE,cAAc;;AAEhB;;;AAGA;EACE,oBAAoB;EACpB,6BAA6B;AAC/B;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;AACf;;;AAGA;EACE,oBAAoB;AACtB;;AAEA;EACE,kBAAkB;AACpB;;;;AAIA;EACE,WAAW;AACb;;AAEA;EACE,YAAY;EACZ,eAAe;EACf,6BAA6B;EAC7B,mBAAmB;EACnB,iBAAiB;CAClB;;AAED;EACE,2BAA2B;CAC5B;;;AAGD;EACE,aAAa;EACb,gBAAgB;EAChB,yBAAyB;AAC3B;;;AAGA;EACE,uBAAuB;EACvB,aAAa;;AAEf;;;;;;AAMA;;EAEE,YAAY;EACZ,yBAAyB;EACzB,YAAY;EACZ,WAAW;EACX,eAAe;EACf,eAAe;EACf,kBAAkB;EAClB,6BAA6B;EAC7B,eAAe;AACjB;;AAEA;;EAEE,uBAAuB;EACvB,yBAAyB;EACzB,cAAc;AAChB;;;;AAIA;EACE,wBAAwB;EACxB,iBAAiB;;AAEnB;;;AAGA;EACE,gBAAgB;AAClB;;AAEA;EACE,YAAY;EACZ,oBAAoB;AACtB;;;AAGA;EACE,YAAY;EACZ,aAAa;EACb,oCAAoC;EACpC,kBAAkB;EAClB,MAAM;EACN,uBAAuB;EACvB,aAAa;EACb,UAAU;AACZ;;AAEA;EACE,uBAAuB;EACvB,kBAAkB;EAClB,uBAAuB;EACvB,kBAAkB;EAClB,eAAe;EACf,aAAa;;AAEf;;;;AAIA;EACE,eAAe;EACf,kBAAkB;EAClB,WAAW;EACX,mBAAmB;AACrB;;;;AAIA;EACE,kBAAkB;EAClB,WAAW;EACX,wBAAwB;EACxB,QAAQ;EACR,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,iBAAiB;AACnB;;;AAGA;EACE,sBAAsB;AACxB;;;AAGA;EACE,iBAAiB;EACjB,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd;;;AAGA;EACE,gBAAgB;EAChB,WAAW;EACX,kBAAkB;;AAEpB;;AAEA;EACE,uBAAuB;EACvB,iBAAiB;EACjB,eAAe;AACjB;;;AAGA;EACE,mCAAmC;EACnC,uBAAuB;AACzB;;;AAGA;EACE,iBAAiB;;AAEnB;;AAEA;EACE,oCAAoC;EACpC,uBAAuB;AACzB;;;;AAIA;EACE,uBAAuB;EACvB,iBAAiB;EACjB,mBAAmB;AACrB;;AAEA;EACE,oBAAoB;EACpB,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;;;AAIA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,6BAA6B;EAC7B,mBAAmB;EACnB,uBAAuB;EACvB,eAAe;EACf,aAAa;AACf;;;AAGA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,gBAAgB;AAClB;;AAEA;EACE,WAAW;EACX,kBAAkB;EAClB,iBAAiB;EACjB,uBAAuB;EACvB,eAAe;AACjB;;AAEA;EACE,qBAAqB;EACrB,uBAAuB;EACvB,iBAAiB;AACnB;;;;;;AAMA;;EAEE;IACE,cAAc;EAChB;;EAEA;IACE,cAAc;IACd,WAAW;EACb;;EAEA;IACE,UAAU;EACZ;;;EAGA;IACE,aAAa;IACb,aAAa;;EAEf;;EAEA;IACE,cAAc;EAChB;;;EAGA;IACE,eAAe;IACf,yBAAyB;IACzB,aAAa;IACb,WAAW;IACX,UAAU;IACV,aAAa;IACb,sBAAsB;IACtB,6BAA6B;IAC7B,eAAe;IACf,oCAAoC;IACpC,4CAA4C;IAC5C,2BAA2B;;;EAG7B;;EAEA;IACE,qCAAqC;IACrC,6CAA6C;;EAE/C;;;CAGD;GACE,gBAAgB;CAClB;;;EAGC;IACE,aAAa;EACf;;EAEA;IACE,oBAAoB;EACtB;;;EAGA;IACE,iBAAiB;IACjB,aAAa;IACb,8BAA8B;IAC9B,8BAA8B;EAChC;;EAEA;IACE,aAAa;IACb,8BAA8B;EAChC;;;;EAIA;;IAEE,SAAS;;EAEX;;;EAGA;IACE,gBAAgB;;EAElB;;EAEA;IACE,WAAW;EACb;;EAEA;IACE,iBAAiB;IACjB,oBAAoB;EACtB;;;;AAIF","sourcesContent":["html {\n  overflow: auto;\n}\n\nbody {\n  margin: 0;\n  font-family: sans-serif;\n}\n\n\n.todo-app {\n  min-height: 100vh;\n  display: flex;\n}\n\n\n.side-bar {\n  border-right: 1px solid black;\n  background-color: #5b78c7;\n}\n\n\n\n.bar {\n  width: 30px;\n  height: 3px;\n  background-color: white;\n  margin: 5px;\n  border-radius: 15px;\n}\n\n\n.toggle-menu {\n  display: none;\n}\n\n\n\n\n.menu-button {\n  width: 100%;\n  margin: 50px 0;\n  padding: 10px;\n  border: none;\n  font-size: 2rem;\n  border-top: 2px solid black;\n  border-bottom: 2px solid black;\n  cursor: pointer;\n  font-weight: bold;\n  background-color: transparent;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n\n}\n\n\n.menu-button:hover {\n  background-color: blanchedalmond;\n}\n\n\n.current-menu-selected {\n  text-decoration: underline;\n  background-color: coral;\n}\n\n\n#all-todo-button::after,\n#projects-button::after,\n#today-button:after,\n#tomorrow-button::after {\n  content: attr(counter-data);\n  font-size: 1rem;\n  border: 1px solid black;\n  margin-left: 5px;\n  padding: 2px;\n\n}\n\n\n.todo-display {\n  width: 80vw;\n  margin: 2vw;\n}\n\n\n.display-menu-header {\n  text-align: center;\n}\n\n\nul {\n  padding: 0;\n}\n\n\n.list {\n  margin-bottom: 5px;\n  list-style: none; \n  border: 1px solid black;\n\n}\n\n.shown-content {\n  display: flex;\n  align-items: center;\n  \n}\n\n\n.task-done {\n  text-decoration: line-through;\n\n}\n\n\n.priority-marker {\n  height: 15px;\n  width: 15px;\n  border-radius: 50%;\n  display: inline-block;\n  margin-left: 5px;\n  vertical-align: middle;\n}\n\n.right-aligned-content {\n  margin-left: auto;\n  display: flex;\n  justify-content: space-between;\n}\n\n\n.buttons-container {\n  display: flex;\n  align-items: center;\n}\n\n.down-arrow,\n.up-arrow,\n.edit-icon {\n  width: 20px;\n}\n\n\n\n.collapse-button {\n  font-size: 0.8rem;\n  background-color: transparent;\n  border-radius: 10px;\n  border: none;\n  cursor: pointer;\n}\n\n.edit-task-button,\n.expand-button {\n  font-size: 0.8rem;\n  background-color: transparent;\n  border-radius: 10px;\n  border: none;\n  cursor: pointer;\n  display: none;\n}\n\n.expand-button,\n.collapse-button {\n  margin: 0 15px;\n\n}\n\n\n.list:hover .show{\n  display: inline-flex;\n  background-color: transparent;\n}\n\n.hide {\n  display: none;\n}\n\n.hide-collapse {\n  display: none;\n}\n\n\n.active {\n  display: inline-flex;\n}\n\n.project-info {\n  text-align: center;\n}\n\n\n\n.delete-bin {\n  width: 35px;\n}\n \n.delete-bin-button {\n  border: none;\n  cursor: pointer;\n  background-color: transparent;\n  border-radius: 15px;\n  margin-left: 10px;\n }\n \n.delete-bin-button:hover {\n  background-color: lightgrey;\n }\n\n\n.hidden-container {\n  display: none;\n  overflow: hidden;\n  background-color: #f1f1f1;\n}\n\n\n.notes-container {\n  border: 1px solid black;\n  padding: 30px;\n\n}\n\n\n\n\n\n.add-new-todo-button,\n.add-new-project-button {\n  color: white;\n  background-color: #008CBA;\n  bottom: 20px;\n  right: 20px;\n  padding: 0 15px;\n  font-size: 3rem;\n  border-radius: 50%;\n  border: 2px solid transparent;\n  cursor: pointer;\n}\n\n.add-new-todo-button:hover,\n.add-new-project-button:hover {\n  background-color: white;\n  border: 2px solid #008CBA;\n  color: #008CBA;\n}\n\n\n\n.new-todo-button-container {\n  margin: 10vh 2vw 3vh 2vw;\n  text-align: right;\n  \n}\n\n\n.stop-scrolling {\n  overflow: hidden;\n}\n\n.move-to-background {\n  opacity: 0.5;\n  pointer-events: none;\n}\n\n\n.form-container {\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(0, 0, 0, 0.7);\n  position: absolute;\n  top: 0;\n  justify-content: center;\n  display: none;\n  z-index: 1;\n}\n\n.form {\n  border: 2px solid black;\n  padding: 60px 30px;\n  background-color: white;\n  position: relative;\n  margin-top: 5vh;\n  height: 400px;\n\n}\n\n\n\n.form-header {\n  font-size: 2rem;\n  text-align: center;\n  width: 100%;\n  margin-bottom: 30px;\n}\n\n\n\n.x-button {\n  position: absolute;\n  right: 10px;\n  transform: rotate(45deg);\n  top: 3px;\n  font-size: 1.5rem;\n  cursor: pointer;\n}\n\n.x-button:hover {\n  font-size: 1.8rem;\n}\n\n\ntable {\n  border-spacing: 0 10px;\n}\n\n\n.form-label {\n  text-align: right;\n  vertical-align: top;\n}\n\ntextarea {\n  resize: none;\n}\n\n\n.form-buttons {\n  margin-top: 20px;\n  width: 100%;\n  text-align: center;\n\n}\n\n.form-buttons button {\n  border: 1px solid white;\n  padding: 5px 10px;\n  cursor: pointer;\n}\n\n\n.submit-button:hover {\n  background-color: rgb(45, 231, 255);\n  border: 1px solid black;\n}\n\n\n.cancel-button {\n  margin-left: 10px;\n\n}\n\n.cancel-button:hover {\n  background-color: rgb(180, 180, 180);\n  border: 1px solid black;\n}\n\n\n\n.project-container {\n  border: 2px solid black;\n  padding: 10px 5px;\n  margin-bottom: 10px;\n}\n\n.project-container:hover .edit-project-button {\n  display: inline-flex;\n  background-color: transparent;\n}\n\n.project-title {\n  display: flex;\n  align-items: center;\n}\n\n\n\n.edit-project-button {\n  margin-left: 50px;\n  font-size: 0.8rem;\n  background-color: transparent;\n  border-radius: 10px;\n  border: 1px solid black;\n  cursor: pointer;\n  display: none;\n}\n\n\n.delete-buttons-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-top: 20px;\n}\n\n.delete-buttons-container button {\n  width: 100%;\n  margin-bottom: 5px;\n  padding: 5px 10px;\n  border: 1px solid white;\n  cursor: pointer;\n}\n\n.delete-buttons-container button:hover {\n  background-color: red;\n  border: 1px solid black;\n  font-weight: bold;\n}\n\n\n\n\n\n@media screen and (max-width: 780px) {\n \n  .todo-app {\n    display: block;\n  }\n\n  .todo-display {\n    margin: 0 auto;\n    width: 95vw;\n  }\n\n  .toggle-menu {\n    z-index: 2;\n  }\n   \n \n  .side-bar {\n    height: 100px;\n    display: flex;\n\n  }\n  \n  .toggle-menu {\n    display: block;\n  }\n\n\n  .nav-links {\n    position: fixed;\n    background-color: #5b78c7;\n    height: 100vh;\n    width: 100%;\n    z-index: 1;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-around;\n    padding: 20px 0;\n    clip-path: circle(100px at 10% -50%);\n    -webkit-clip-path: circle(100px at 10% -50%);\n    transition: all 1s ease-out;\n\n    \n  }\n\n  .nav-links.open {\n    clip-path: circle(1200px at 10% -10%);\n    -webkit-clip-path: circle(1200px at 10% -10%);\n\n  }\n\n\n .project-info {\n   font-size: .6rem;\n }\n\n\n  .hide-small-window {\n    display: none;\n  }\n\n  .show {\n    display: inline-flex;\n  }\n \n\n  .right-aligned-content {\n    margin-left: auto;\n    display: flex;\n    justify-content: space-between;\n    flex-direction: column-reverse;\n  }\n\n  .buttons-container {\n    display: flex;\n    justify-content: space-between;\n  }\n\n \n\n  .expand-button,\n  .collapse-button {\n    margin: 0;\n\n  }\n\n\n  .delete-bin-button {\n    margin-left: 5px;\n\n  }\n\n  .delete-bin {\n    width: 25px;\n  }\n\n  .edit-project-button {\n    margin-left: auto;\n    display: inline-flex;\n  }\n\n\n\n}"],"sourceRoot":""}]);
// Exports
  ...
  const createListOfTasks = (listOfTasks, allTodosArray) => {
    ...
    listOfTasks.forEach(task => {
      ...
      checkBox.addEventListener('click', (e) => {
        ...
        let currentObj = ___WEBPACK_IMPORTED_MODULE_0__.todo.getTodoList()[objIndex];

        e.target.checked ? currentObj.isTodoDone = true : currentObj.isTodoDone = false
        ___WEBPACK_IMPORTED_MODULE_0__.todo.updateLocalStorage();
      });
...
const todo = (() => {
  ...
  const todoFactory = (data) => {
    ...
    data.get('due-date') == '' ? dueDate = data.get('due-date')    
                              :dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(data.get('due-date'));
  ...
  const saveEditChanges = (e) => {
    if (_editForm.reportValidity()) {
      ...
      newDueDate == ''? delete _todoObj.dueDate: _todoObj.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(newDueDate);
  ...
  let _todoList = [
    {
      ...
      dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])('2022-02-10'),
      priority: "medium",
      isTodoDone: false,
    ...
    {
      title: "Do groceries",
      dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])('2021-12-15'),
      priority: "high",
      isTodoDone: false,
...

    {
      ...
      dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])('2021-12-20'),
      priority: "medium",
      isTodoDone: false,
...

    {
      ...
      dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])('2021-11-29'),
      priority: "low",
      isTodoDone: false,
      notes: '',
      project: "Home"
    ...
    {
      title: "Big Game",
      dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])('2022-02-13'),
      priority: "medium",
      isTodoDone: false,
      notes: '',
      project: "Home"
  ...
  deleteProjectButton.addEventListener('click', function(e) {
    ...
    _render__WEBPACK_IMPORTED_MODULE_0__.renderTodo.closeForm(findCurrentFormInUse())
    _render__WEBPACK_IMPORTED_MODULE_0__.renderTodo.updatePage(_menuCurrently)
  });
...
const renderTodo = (() => {
  ...
  const prefillEditForm = (e) => { 
    ...
    if (_currentTodoObject.hasOwnProperty('dueDate') && _currentTodoObject.dueDate !== '') {
      _editDueDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(_currentTodoObject.dueDate, 'yyyy-MM-dd');
    }
